...
public class IdentityContext : IdentityDbContext<AppUser>
{
    ...
    //        new ProductEntity { Id = 2, Title = "Logitech MK549 Advanced", Price = 500, ImageUrl = "https://cf-images.dustin.eu/cdn-cgi/image/format=auto,quality=75,width=640,,fit=contain//image/d200001001725842/logitech-mk540-advanced-nordiska-l%C3%A4underna-sats-med-tangentbord-och-mus.jpg", Description = " blalala " }
    //         );
